...
This makes sense with the first model, because the pay gap has remained relatively the same, it is hard to show that just being female makes a significant change Average Median Income. 
