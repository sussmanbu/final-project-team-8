...
glm_model <- glm(Income ~ Race + Gender + Bachelors_Attainment, data = modeling_data, family = gaussian())

glm_model2 <- glm(Income ~ Race + Gender, data = modeling_data, family = gaussian())
