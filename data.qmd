...
(Variables in dataset 3 not yet)

**U.S. Department of Labor (DOL) Data**

Regarding the World Bank database, its variables contain time, educational attainment, employment rate, unemployment rate, and gender. The time variable is broken down by year and ranges from 1960 to 2023. The educational attainment variable is broken down by at least master or doctoral and is shown as a percentage through the gender variable. The employment rate and unemployment rate are shown as a percentage by gender, and are related to the education level by age.
