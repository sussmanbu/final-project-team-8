...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectInput("race", "Select race:", choices = c(
        "White Alone", 
...
server <- function(input, output) {
  output$image <- renderImage({
    gender <- input$gender
    race <- input$race
    file_path <- paste0("bigpic_povertyimage/", gender, " ", race, ".jpg")
    list(src = file_path, contentType = 'image/jpeg', width = '100%', height = 'auto')
  }, deleteFile = FALSE)
}
