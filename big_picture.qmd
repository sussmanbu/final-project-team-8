...
<<<<<<< HEAD
This project uses a variety of statistical techniques to try to answer
=======
This project uses a variety of statistical techniques to try to answer questions pretaining to gender, education and race. This caused us to reach the following conclusions:

- When Income is regressed against Gender, Race, and Education, certain groups are doing greatly better than others
  - For example, Hispanic men and women have a significantly lower income than White men and women, but comparatively, Hispanic men are significantly better.
  
- Overall, the disparity that women receive facing income does not appear to be changing.


>>>>>>> b2ad943d763a5373d7c9bc02e45dff4e3c117dc0
