...
# Alabama
us_aian_data <- filter(acs_data, Label == "Bachelor's degree or higher****")
bdh_aianalone_alabama <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`Alabama...13`,
...
bdh_aianalone_alaska <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...25`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_arizona <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...37`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_arkansas <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...49`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_california <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...61`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_colorado <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...73`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_connecticut <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...85`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_delaware <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...97`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_florida <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...109`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_georgia <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...121`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_hawaii <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...133`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_idaho <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...145`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_illinois <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...157`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_indiana <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...169`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_iowa <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...181`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_kansas <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...193`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_kentucky <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...205`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_louisiana <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...217`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_maine <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...229`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_maryland <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...241`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_massachusetts <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...253`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_michigan <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...265`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_minnesota <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...277`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_mississippi <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...289`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_missouri <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...301`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_montana <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...313`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_nebraska <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...325`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_nevada <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...337`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_newhampshire <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...349`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_newjersey <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...361`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_newmexico <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...373`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_newyork <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...385`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_northcarolina <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...397`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_northdakota <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...409`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_ohio <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...421`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_oklahoma <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...433`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_oregon <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...445`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_pennsylvania <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...457`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_rhodeisland <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...469`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_southcarolina <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...481`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_southdakota <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...493`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_tennessee <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...505`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_texas <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...517`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_utah <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...529`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_vermont <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...541`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_virginia <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...553`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_washington <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...565`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_westvirginia <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...577`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_wisconsin <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...589`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_wyoming <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...601`,
  Race = "American Indian or Alaska Native Alone"
)
...
bdh_aianalone_puertorico <- tibble(
  Years = us_aian_data$Years,
  Percentage_aiap_women = us_aian_data$`...613`,
  Race = "American Indian or Alaska Native Alone"
)
