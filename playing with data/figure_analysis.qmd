...
### This table shows the percent difference between the proportions of males who live above the poverty line and females, split by race and state. It is a way of showing the raw data of the differeneces we can observe on the heat maps between races.
...
for (x in column_names) {
  print(
    ggplot(data = poverty_plot, aes(fill = .data[[x]])) +
      geom_sf() +
      coord_sf(crs = 5070) +
